        ...
        >
            ...
            >
                ...
                <transition name="text-slide">
                    <span v-show="hover" class="control-text">{{
                        controlText
                    }}</span>
                </transition>
    ...
    setup(props) {
        ...
        const codeAreaHeight = computed(() => {
            if (description.value) {
                return (
                    description.value.clientHeight +
                    highlight.value.clientHeight +
                    20
                );
            }
        ...
        const _scrollHandler = () => {
            ...
            fixedControl.value =
                bottom > innerHeight && top + 44 <= innerHeight;
